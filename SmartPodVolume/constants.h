...
// all in utf-8
namespace conf_key {
	inline constexpr const char* BLACKLIST = "blacklist"; // object
	inline constexpr const char* WHITELIST = "whitelist"; // object
...
// {F45B61B6-2ECA-4B80-9767-DDB154BF5012}
inline constexpr GUID VOLUME_SETTER_GUID =
{ 0xf45b61b6, 0x2eca, 0x4b80, { 0x97, 0x67, 0xdd, 0xb1, 0x54, 0xbf, 0x50, 0x12 } };
